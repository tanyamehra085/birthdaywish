...
new TypeIt("#teks1", {
  strings: [
      `Happy Birthday, Nashedi 🎂😘😍😍🥰😘

2 January se baat shuru hui thi, aur maine socha bhi nahi tha
ki ek simple sa “kya tu mera greeting card wala dost banega?”
mujhe ek aisa insaan de dega
jisse baat karte-karte time, neend aur battery sab khatam ho jaaye 😂

Tu mujhe ganjedi bolta hai 🌿,
main tujhe nashedi 🍻,
par honestly lagta hai hum dono
sirf bakchodi ke high pe jee rahe hain 😌

Aur haan… wo humari biryani 🍲
jo itni slow pak rahi hai
ki lagta hai jab tak wo ready hogi,
tab tak hum buddhe ho chuke honge 😂
Par koi baat nahi, dum ache se lage
kyunki patience bhi toh dosti ka test hota hai 😜

Baat karte-karte raat se subah ho jaana 🌙➡️🌞
aur phir bolna,
“bas 5 min aur baat karte hain”
jo actually 2 ghante ho jaate hain —
ye skill sirf hum dono ke paas hai 😆

Tu thoda annoying hai 😏,
thoda zyada hi overconfident 😎,
aur kabhi-kabhi aise jokes maarta hai
jinko sirf main hi funny samajhti hoon 😂
par phir bhi tu apna hi lagta hai 🫶

Aaj tera din hai 🎉
cake tera 🎂, wishes teri 😌,
aur roast — bilkul free 😆

Bas wish itni si hai ki
tu hamesha aisa hi rahe —
thoda sa pagal, thoda sa irritating,
par 100% real 💙

Once again, Happy Birthday 🥳
party tu dega,
biryani kab ready hogi wo dekh lenge 😜

— from your favorite ganjedi 🌿😄`,,
  ],
  startDelay: 4000,
  speed: 75,
  ...
  afterComplete: async (instance) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        // ⭐ Paper ke baad photo slide open
        _slidePhoto();
      }, 1000);
    }, 2000);
  },
}).go();
const _slidePhoto = function () {
  const slidePhoto = document.getElementById("slidePhoto");

  slidePhoto.classList.remove("d-none");
};
